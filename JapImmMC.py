...
plt.figure()
plt.subplot(2,2,1)
plt.plot(time, Yavg[0:nobs-1]/GDPbar, 'k-')
plt.plot(time, Yupp[0:nobs-1]/GDPbar, 'k:')
plt.plot(time, Ylow[0:nobs-1]/GDPbar, 'k:')
plt.title('GDP')
plt.xticks([])
plt.subplot(2,2,2)
plt.plot(time, Cavg[0:nobs-1]/Cbar, 'k-')
plt.plot(time, Cupp[0:nobs-1]/Cbar, 'k:')
plt.plot(time, Clow[0:nobs-1]/Cbar, 'k:')
plt.title('Consumption')
plt.xticks([])
plt.subplot(2,2,3)
plt.plot(time, Iavg[0:nobs-1]/Ibar, 'k-')
plt.plot(time, Iupp[0:nobs-1]/Ibar, 'k:')
plt.plot(time, Ilow[0:nobs-1]/Ibar, 'k:')
...
plt.figure()
plt.subplot(2,2,1)
plt.plot(time, wSavg[0:nobs-1]/wSbar, 'k-')
plt.plot(time, wSupp[0:nobs-1]/wSbar, 'k:')
plt.plot(time, wSlow[0:nobs-1]/wSbar, 'k:')
plt.title('Skilled Wage')
plt.xticks([])
plt.subplot(2,2,2)
plt.plot(time, wUavg[0:nobs-1]/wUbar, 'k-')
plt.plot(time, wUupp[0:nobs-1]/wUbar, 'k:')
plt.plot(time, wUlow[0:nobs-1]/wUbar, 'k:')
plt.title('Unskilled Wage')
plt.xticks([])
plt.subplot(2,2,3)
plt.plot(time, sSavg[0:nobs-1]/sSbar, 'k-')
plt.plot(time, sSupp[0:nobs-1]/sSbar, 'k:')
plt.plot(time, sSlow[0:nobs-1]/sSbar, 'k:')
plt.title('Skilled Interest Rate')
plt.subplot(2,2,4)
plt.plot(time, sUavg[0:nobs-1]/sUbar, 'k-')
plt.plot(time, sUupp[0:nobs-1]/sUbar, 'k:')
plt.plot(time, sUlow[0:nobs-1]/sUbar, 'k:')
...
plt.figure()
plt.subplot(2,2,1)
plt.plot(time, USDavg[0:nobs-1]/USDbar, 'k-')
plt.plot(time, USDupp[0:nobs-1]/USDbar, 'k:')
plt.plot(time, USDlow[0:nobs-1]/USDbar, 'k:')
plt.title('Skilled Domestic')
plt.xticks([])
plt.subplot(2,2,2)
plt.plot(time, UUDavg[0:nobs-1]/UUDbar, 'k-')
plt.plot(time, UUDupp[0:nobs-1]/UUDbar, 'k:')
plt.plot(time, UUDlow[0:nobs-1]/UUDbar, 'k:')
plt.title('Unskilled Domestic')
plt.xticks([])
plt.subplot(2,2,3)
plt.plot(time, USIavg[0:nobs-1]/USIbar, 'k-')
plt.plot(time, USIupp[0:nobs-1]/USIbar, 'k:')
plt.plot(time, USIlow[0:nobs-1]/USIbar, 'k:')
plt.title('Skilled Immigrant')
plt.subplot(2,2,4)
plt.plot(time, UUIavg[0:nobs-1]/UUIbar, 'k-')
plt.plot(time, UUIupp[0:nobs-1]/UUIbar, 'k:')
plt.plot(time, UUIlow[0:nobs-1]/UUIbar, 'k:')
